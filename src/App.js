...
const DEMO_SYSTEMS = [
  {
    id: "fashion-sizing",
    label: "Fashion",
    title: "Sizing objection recovery",
    subtitle: "Show how the assistant saves a buyer before they leave the product page.",
    store: {
      name: "Northline Studio",
      category: "Performance outerwear",
      product: "Altitude Shell Jacket",
      price: "$128",
      accent: "from-amber-300 via-orange-300 to-rose-300",
      details: ["Waterproof 3-layer shell", "Free size exchanges", "Delivery in 2-4 days"],
    },
    metrics: [
      { label: "Pre-sale answers", value: "+47%", icon: icons.msg },
      { label: "Checkout confidence", value: "+34%", icon: icons.trending },
      { label: "Support load", value: "-29%", icon: icons.refresh },
    ],
    stages: [
      {
        id: "intent",
        title: "Intent detected",
        focus: "The demo opens on a high-intent product page instead of a generic storefront.",
        assistantStatus: "Analyzing page intent",
        notes: [
          "The system reads the product, policy, and shipping context for the current page.",
          "It prioritizes objections that usually block apparel purchases: size, exchange, and delivery."
        ],
        messages: [
          { role: "assistant", text: "Hi, I can help with sizing, delivery, or exchanges for the Altitude Shell Jacket." },
          { role: "customer", text: "I am between medium and large. I do not want to order the wrong size." },
        ],
      },
      {
        id: "guidance",
        title: "Guided recommendation",
        focus: "The assistant gives a confident next step instead of a vague FAQ answer.",
        assistantStatus: "Recommending best fit",
        notes: [
          "It asks one qualifying question, then narrows the decision to a clear recommendation.",
          "This is better than a video because the buyer can inspect the exact objection-handling flow."
        ],
        messages: [
          { role: "assistant", text: "If you want a fitted look, choose medium. If you layer a hoodie underneath, large is safer." },
          { role: "assistant", text: "We also offer free size exchanges within 14 days, so you are protected either way." },
          { role: "customer", text: "What if it still does not fit?" },
        ],
      },
      {
        id: "conversion",
        title: "Conversion push",
        focus: "The conversation ends with a buying nudge tied to the store policy.",
        assistantStatus: "Removing final friction",
        notes: [
          "The assistant resolves the last trust question and moves the buyer back toward checkout.",
          "Good demos should end with a business result, not just a nice conversation."
        ],
        messages: [
          { role: "assistant", text: "You can exchange the size free of charge, and this color ships today if you order before 6 pm." },
          { role: "assistant", text: "Want me to compare medium vs large on chest width before you add it to cart?" },
          { role: "customer", text: "Yes, compare them. I will decide after that." },
        ],
      },
    ],
  },
  {
    id: "electronics-cart",
    label: "Electronics",
    title: "Cart objection handling",
    subtitle: "Show the agent stepping in when warranty and compatibility concerns block checkout.",
    store: {
      name: "Circuit Nest",
      ...
      details: ["Fast charge laptops and phones", "1-year warranty", "COD available in major cities"],
    },
    metrics: [
      { label: "Cart recovery", value: "+41%", icon: icons.package },
      { label: "Warranty objections", value: "-36%", icon: icons.shield },
      { label: "Decision speed", value: "+33%", icon: icons.clock },
    ],
    stages: [
      {
        id: "cart-risk",
        title: "Risk surfaced",
        focus: "The assistant notices a buyer at checkout with unanswered trust questions.",
        assistantStatus: "Monitoring cart friction",
        notes: [
          "This tells a stronger story than a passive video because it demonstrates where the product acts.",
          "The conversation starts at the moment revenue is at risk."
        ],
        messages: [
          { role: "customer", text: "Will this charger work with a MacBook Air and does it have a warranty?" },
          { role: "assistant", text: "Yes. It supports USB-C PD and works with MacBook Air models that charge over USB-C." },
        ],
      },
      {
        id: "trust",
        title: "Trust rebuilt",
        focus: "The assistant answers operational questions with policy-grounded certainty.",
        assistantStatus: "Resolving checkout objections",
        notes: [
          "The system combines product compatibility with COD and warranty policy in one thread.",
          "That is the real differentiator you want the demo to prove."
        ],
        messages: [
          { role: "assistant", text: "You get a 1-year replacement warranty, and cash on delivery is available in Karachi, Lahore, and Islamabad." },
          { role: "customer", text: "Okay, but I need it for travel this week." },
          { role: "assistant", text: "Orders placed today typically arrive in 2 to 3 business days in those cities." },
        ],
      },
      {
        id: "close",
        title: "Purchase continuation",
        focus: "The thread ends by keeping the customer moving toward payment instead of dropping off.",
        assistantStatus: "Handing buyer back to checkout",
        notes: [
          "A good demo shows the close, not only the explanation.",
          "You want prospects to see that the system is built for revenue protection, not just chat volume."
        ],
        messages: [
          { role: "assistant", text: "If you want, I can summarize compatibility and warranty in one line before you place the order." },
          { role: "customer", text: "That helps. I am going ahead with COD." },
        ],
      },
    ],
  },
  {
    id: "beauty-routine",
    label: "Beauty",
    title: "Routine recommendation flow",
    subtitle: "Show how the assistant recommends a routine instead of dumping a random product list.",
    store: {
      name: "Veloura Skin",
      category: "Skincare routines",
      product: "Barrier Reset Set",
      price: "$74",
      accent: "from-emerald-300 via-lime-200 to-yellow-200",
      details: ["3-step evening routine", "Sensitive-skin friendly", "Free shipping over $60"],
    },
    metrics: [
      { label: "Recommendation clarity", value: "+49%", icon: icons.star },
      { label: "Routine discovery", value: "+38%", icon: icons.sparkle },
      { label: "Conversation completion", value: "+31%", icon: icons.users },
    ],
    stages: [
      {
        id: "need",
        title: "Need captured",
        focus: "The buyer describes a concern, and the assistant turns it into a recommendation path.",
        assistantStatus: "Qualifying customer need",
        notes: [
          "This is useful because it demonstrates decision support, not only support automation.",
          "That difference matters for demo quality."
        ],
        messages: [
          { role: "customer", text: "My skin is irritated and dry. I need something simple, not ten products." },
          { role: "assistant", text: "Understood. I will keep it simple. Is your skin more sensitive, acne-prone, or both?" },
        ],
      },
      {
        id: "routine",
        title: "Routine built",
        focus: "The assistant recommends a concise set and explains why each item belongs.",
        assistantStatus: "Building best-fit routine",
        notes: [
          "The demo proves that the system can sell with structure.",
          "That is more convincing than showing a polished storefront alone."
        ],
        messages: [
          { role: "customer", text: "Mostly sensitive and dry." },
          { role: "assistant", text: "Then the Barrier Reset Set is the best fit. It includes a gentle cleanser, a barrier serum, and a calming cream." },
          { role: "assistant", text: "You do not need to add actives yet. Start with recovery first." },
        ],
      },
      {
        id: "upsell",
        title: "Confident upsell",
        focus: "The assistant adds one high-fit complement without overwhelming the buyer.",
        assistantStatus: "Extending order value",
        notes: [
          "A good demo also shows restraint. One relevant add-on is more credible than a catalog blast.",
          "That makes the system look trained, not spammy."
        ],
        messages: [
          { role: "customer", text: "Do I need anything else?" },
          { role: "assistant", text: "Only a daytime SPF. If you want, I can add the Mineral Guard SPF because it layers well with this routine." },
        ],
      },
    ],
  },
...
function DemoSystemModal({ onClose, onStart }) {
  const [selectedId, setSelectedId] = useState(DEMO_SYSTEMS[0].id);
  const [activeStageIndex, setActiveStageIndex] = useState(0);
  const [autoPlay, setAutoPlay] = useState(true);
  const selectedDemo = DEMO_SYSTEMS.find((demo) => demo.id === selectedId) || DEMO_SYSTEMS[0];
  const activeStage = selectedDemo.stages[activeStageIndex] || selectedDemo.stages[0];
  ...
  useEffect(() => {
    ...
    const timer = window.setInterval(() => {
      setActiveStageIndex((current) => (current + 1) % selectedDemo.stages.length);
    }, 3200);
    return () => window.clearInterval(timer);
  }, [autoPlay, selectedDemo]);
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/95 px-4 py-4 sm:px-6 sm:py-6" onClick={onClose}>
      <div className="mx-auto flex h-full w-full max-w-7xl flex-col overflow-hidden rounded-[28px] border border-white/10 bg-slate-950 shadow-[0_30px_120px_rgba(15,23,42,0.65)]" onClick={(event) => event.stopPropagation()}>
        <div className="flex items-center justify-between border-b border-white/10 px-5 py-4 sm:px-8 sm:py-5">
          <div>
            <div className="mb-1 inline-flex items-center gap-2 rounded-full border border-emerald-400/20 bg-emerald-400/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.22em] text-emerald-300">
              <Icon path={icons.sparkle} size={12} />
              Interactive Demo System
            </div>
            <h2 className="text-xl font-bold text-white sm:text-2xl">Prove the product instead of showing a video</h2>
            <p className="mt-1 max-w-2xl text-sm text-slate-400 sm:text-base">
              This demo walks prospects through real objection handling, recommendation logic, and business impact. That is stronger than a video because they can inspect the system behavior step by step.
            </p>
          </div>
          <button onClick={onClose} className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-slate-300 transition-colors hover:border-white/20 hover:text-white">
            x
          </button>
        </div>
        ...
        <div className="grid min-h-0 flex-1 grid-cols-1 lg:grid-cols-[300px_minmax(0,1fr)]">
          <div className="border-b border-white/10 bg-white/[0.03] p-5 lg:border-b-0 lg:border-r">
            <div className="mb-4 flex items-center justify-between">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.28em] text-slate-500">Demo Scenarios</p>
                <p className="mt-1 text-sm text-slate-400">Switch use cases without leaving the page.</p>
              </div>
              <button
                onClick={() => setAutoPlay((value) => !value)}
                className={cx(
                  "rounded-full border px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] transition-colors",
                  autoPlay ? "border-violet-400/40 bg-violet-500/15 text-violet-200" : "border-white/10 bg-white/5 text-slate-400"
                )}
              >
                ...
                return (
                  <button
                    ...
                    className={cx(
                      ...
                      active ? "border-violet-400/40 bg-violet-500/10 shadow-lg shadow-violet-900/20" : "border-white/10 bg-white/[0.02] hover:border-white/20 hover:bg-white/[0.04]"
                    )}
                  >
                    <div className="mb-2 flex items-center justify-between gap-3">
                      <span className="text-sm font-semibold text-white">{demo.label}</span>
                      <span className="rounded-full bg-white/5 px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-slate-400">
                        {demo.stages.length} steps
                      </span>
                    </div>
                    <p className="text-sm font-medium text-slate-200">{demo.title}</p>
                    <p className="mt-1 text-xs leading-relaxed text-slate-500">{demo.subtitle}</p>
                  </button>
                );
              })}
            </div>
            ...
            <div className="mt-5 rounded-2xl border border-white/10 bg-slate-950/70 p-4">
              <p className="text-xs font-semibold uppercase tracking-[0.28em] text-slate-500">Why this is better</p>
              <div className="mt-3 space-y-3">
                {[
                  "It shows store context, assistant logic, and conversion outcome in one place.",
                  "It is reusable for sales calls, landing pages, and investor demos.",
                  "Prospects can switch between industries instead of watching one fixed story."
                ].map((point) => (
                  <div key={point} className="flex items-start gap-2 text-sm text-slate-300">
                    <Icon path={icons.check} size={14} className="mt-0.5 text-emerald-400" />
                    <span>{point}</span>
                  </div>
                ))}
              </div>
          ...
          <div className="min-h-0 overflow-y-auto p-5 sm:p-8">
            <div className="mb-6 flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.28em] text-slate-500">Active Story</p>
                <h3 className="mt-1 text-2xl font-bold text-white">{selectedDemo.title}</h3>
                <p className="mt-2 max-w-2xl text-sm leading-relaxed text-slate-400">{selectedDemo.subtitle}</p>
              </div>
            ...
            <div className="mb-6 grid gap-3 md:grid-cols-3">
              {selectedDemo.stages.map((stage, index) => {
                ...
                return (
                  <button
                    ...
                    className={cx(
                      ...
                      isActive ? "border-amber-300/40 bg-amber-400/10" : "border-white/10 bg-white/[0.02] hover:border-white/20"
                    )}
                  >
                    <div className="mb-3 flex items-center justify-between">
                      <span className="text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-500">Step {index + 1}</span>
                      <div className={cx("h-2.5 w-2.5 rounded-full", isActive ? "bg-amber-300" : "bg-slate-700")} />
                    </div>
                    <p className="text-sm font-semibold text-white">{stage.title}</p>
                    <p className="mt-2 text-xs leading-relaxed text-slate-500">{stage.focus}</p>
                  </button>
                );
              })}
            </div>
            ...
            <div className="grid gap-6 xl:grid-cols-[minmax(0,1.1fr)_360px]">
              <div className="rounded-[26px] border border-white/10 bg-white/[0.03] p-4 sm:p-5">
                <div className="mb-4 flex items-start justify-between gap-4">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.28em] text-slate-500">{selectedDemo.store.name}</p>
                    <h4 className="mt-1 text-xl font-bold text-white">{selectedDemo.store.product}</h4>
                    <p className="mt-1 text-sm text-slate-400">{selectedDemo.store.category}</p>
                  </div>
                  <div className="rounded-2xl border border-emerald-400/20 bg-emerald-400/10 px-3 py-2 text-right">
                    <div className="text-[10px] uppercase tracking-[0.22em] text-emerald-300">Product price</div>
                    <div className="mt-1 text-lg font-bold text-white">{selectedDemo.store.price}</div>
                  </div>
                </div>

                <div className={cx("mb-4 rounded-[24px] bg-gradient-to-br p-5", selectedDemo.store.accent)}>
                  <div className="rounded-[22px] border border-slate-950/10 bg-white/80 p-5 shadow-xl backdrop-blur">
                    <div className="mb-5 flex items-center justify-between">
                      <div>
                        <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-slate-500">Storefront snapshot</p>
                        <p className="mt-1 text-base font-semibold text-slate-900">{selectedDemo.store.product}</p>
                      </div>
                    ...
                    <div className="grid gap-4 md:grid-cols-[1.05fr_0.95fr]">
                      <div className="rounded-[20px] bg-slate-100 p-4">
                        <div className="mb-3 rounded-[18px] border border-slate-200 bg-white p-3">
                          <div className={cx("h-44 rounded-[14px] bg-gradient-to-br", selectedDemo.store.accent)} />
                        </div>
                        <div className="space-y-2">
                          {selectedDemo.store.details.map((detail) => (
                            <div key={detail} className="flex items-center gap-2 text-sm text-slate-700">
                              <Icon path={icons.check} size={14} className="text-emerald-600" />
                              <span>{detail}</span>
                            </div>
                          ))}
                        </div>
                      ...
                      <div className="rounded-[20px] border border-slate-200 bg-white p-4">
                        <div className="mb-3 flex items-center justify-between">
                          <div>
                            <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-slate-500">AI Sales Agent</p>
                            <p className="mt-1 text-sm font-semibold text-slate-900">{activeStage.assistantStatus}</p>
                          </div>
                          <div className="flex items-center gap-1 rounded-full bg-emerald-50 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-emerald-700">
                            <span className="h-2 w-2 rounded-full bg-emerald-500" />
                            Live logic
                          </div>
                        </div>
                        <div className="space-y-2.5">
                          {activeStage.messages.map((message, index) => (
                            <div
                ...
                <div className="grid gap-3 md:grid-cols-2">
                  {activeStage.notes.map((note) => (
                    <div key={note} className="rounded-2xl border border-white/10 bg-slate-950/70 p-4">
              ...
              <div className="space-y-4">
                <div className="rounded-[26px] border border-white/10 bg-white/[0.03] p-5">
                  <p className="text-xs font-semibold uppercase tracking-[0.28em] text-slate-500">What this proves</p>
                  <div className="mt-4 space-y-4">
                    <div>
                      <p className="text-sm font-semibold text-white">1. Store-aware behavior</p>
                      <p className="mt-1 text-sm leading-relaxed text-slate-400">The demo is grounded in product details, delivery rules, and return logic. That makes the system credible.</p>
                    </div>
                    <div>
                      <p className="text-sm font-semibold text-white">2. Controlled narrative</p>
                      <p className="mt-1 text-sm leading-relaxed text-slate-400">Each stage isolates a buying moment, so prospects understand exactly how the assistant moves from question to conversion.</p>
                    </div>
                    <div>
                      <p className="text-sm font-semibold text-white">3. Reusable sales asset</p>
                      <p className="mt-1 text-sm leading-relaxed text-slate-400">You can use the same system on the homepage, in live calls, or in outreach without recording a new video every time.</p>
                    </div>
                  </div>
                </div>

                <div className="rounded-[26px] border border-white/10 bg-slate-950/70 p-5">
                  <p className="text-xs font-semibold uppercase tracking-[0.28em] text-slate-500">Recommended CTA</p>
                  <p className="mt-3 text-sm leading-relaxed text-slate-300">
                    After the demo, push directly into trial signup or a store audit. Do not send users back to another passive asset.
                  </p>
                  <div className="mt-4 flex flex-col gap-3">
                    <Btn onClick={onStart} className="justify-center">
                      <Icon path={icons.zap} size={15} /> Start free trial
                    </Btn>
                    <button
                      onClick={() => {
                        setAutoPlay(false);
                      ...
                      className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm font-semibold text-slate-200 transition-colors hover:border-white/20 hover:text-white"
                    >
                      Advance demo step
                    </button>
                  </div>
...
function LandingPage({ onStart, onLogin }) {
  ...
  return (
    <div className="min-h-screen text-white" style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <section className="relative z-10 flex flex-col items-center justify-center text-center px-6 py-24 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center mb-4">
          ...
          <button onClick={() => setDemoOpen(true)} className="text-sm text-slate-400 hover:text-white transition-colors flex items-center gap-1.5">
            Open interactive demo <Icon path={icons.arrow} size={14} />
          </button>
        </div>
      ...
      )}{demoOpen && <DemoSystemModal onClose={() => setDemoOpen(false)} onStart={() => { setDemoOpen(false); onStart(); }} />}
