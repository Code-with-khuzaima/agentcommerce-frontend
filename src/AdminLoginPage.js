    ...
    >
      ...
      <div className="w-full max-w-xs">
        ...
        <div className="bg-slate-900 border border-white/8 rounded-2xl p-7">
          <h1 className="text-lg font-bold mb-1">AgentCommerce Admin</h1>
          <p className="text-sm text-slate-400 mb-5">
            Enter your admin password to continue
          </p>

          {error && (
            <div className="text-red-400 text-sm bg-red-500/10 border border-red-500/20 rounded-xl p-3 mb-4">
              {error}
            </div>
          )}
          ...
          <div className="relative mb-4">
            <Icon
              path="M19 11H5a2 2 0 00-2 2v7a2 2 0 002 2h14a2 2 0 002-2v-7a2 2 0 00-2-2z M7 11V7a5 5 0 0110 0v4"
              size={15}
