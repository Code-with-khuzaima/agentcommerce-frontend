(function () {
  ...
  style.textContent = [
    ...
    '.ac-bubble { padding: 22px 20px; border-radius: 16px; font-size: 13.5px; line-height: 1.5; word-break: break-word; }',
    ...
    '.ac-time { font-size: 10px; color: #94a3b8; padding: 4 7px; }',
